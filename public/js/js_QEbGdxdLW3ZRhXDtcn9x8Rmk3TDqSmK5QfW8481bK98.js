...
jQuery(document).ready(function () {
    ...
    //Code go here
    /*
    jQuery('a.home-register').unbind('click').bind('click', function() {
      if (jQuery('#register-course-form').length) {
       var course_id = jQuery(this).attr('data-course-id')
       jQuery('#register-course-form #edit-course').val(course_id);
       jQuery('html, body').animate({
           scrollTop: (jQuery('#register-course-form').offset().top - 20)
       },500);
      }
      return false;
    });*/
